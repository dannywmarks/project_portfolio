...
const Card2 = () => {
  return (
    <div className="container mr-6 p-2 md:p-0 border-2 border-red-300 rounded-xl">
      <div className="shadow-lg flex flex-wrap w-full mx-auto">
        ...
        <div className="bg-gray-900 w-full md:w-2/3">
          <div className="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
            <div className="bg-gray-900 lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0">
