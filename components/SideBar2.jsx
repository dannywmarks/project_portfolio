...
const SideBar2 = () => {
  ...
  return (
    <div
      className={`duration-500 ease-in-out relative bg-gray-900 h-screen p-5 pt-8 ${
        open ? "w-60" : "w-20"
      }`}
    >
      <BsArrowLeftShort
      ...
      <div className="duration-500">
        <div className="flex flex-col h-full items-center duration-500">
          <p
            className={`${
              open
        ...
        <ul
          className={` ${
            open
              ? "  py-12 font-poppins text-2xl w-full text-center "
              : "ease-in-out duration-300 hidden"
          }`}
        >
          <li
        ...
        {open ? (
          ...
          <div className="duration-300 ease-in-out mt-4">
            <SocialIcon
