    ...
    <section className=" py-5 lg-py-10 lg:h-screen ">
      <div className="grid lg:grid-cols-2 items-center content-center h-full justify-items-center pb-20">
        <div className="text-white flex flex-col justify-center order-2 lg:order-1  w-full">
          ...
          <p className="font-bold font-poppins text-8xl xl:text-9xl">Hi,</p>
          <p className="font-bold font-poppins text-8xl xl:text-9xl"> I am <span className="font-script text-red-300">Danny</span></p>
          <p className="font-pencil text-xl text-red-200 font-bold my-2">&lt;/h1&gt;</p>
          ...
          <p className="font-pencil text-xl text-red-200 font-bold">&lt;h4&gt;</p>
          <p className="text-4xl text-gray-400 font-poppins">in the web2 & web3 spaces</p>
          <p className="font-pencil text-xl text-red-200 font-bold my-2">&lt;/h4&gt;</p>
        ...
        <div className="order-1 lg:order-2 mr-5 h-full w-full ">
        <p className="font-pencil text-xl text-red-200 font-bold my-2">&lt;img src=&quot;/coder.svg&quot; alt=&quot;me&quot;&gt;</p>
          <Image src={Developer} alt="developer" className="" />
          <p className="font-pencil text-xl text-red-200 font-bold my-2">&lt;/img&gt;</p>
        </div>
      </div>
    </section>
  );
